...
#This program runs a simulation of a quadcopter taking off, going to some presets points, releasing a cargo and returning to launch to land.
...
print("Going towards fourth point to deliver the package")
point4 = LocationGlobalRelative(53.382359, -1.494300, 20)
